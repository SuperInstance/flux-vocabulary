...
Each vocabulary folder contains .fluxvocab files:
    ...
    result: R0
    name: what-is-add
    description: Natural language addition
    tags: core, math, natural-language
...
class Vocabulary:
    ...
    def list_by_tag(self, tag: str) -> List[VocabEntry]:
        """List entries matching a specific tag."""
    ...
    def stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "loaded_paths": sorted(list(self._loaded_paths)),
        }
